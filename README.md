...
The current framework uses 224 × 224-pixel patches at 20× magnification, which provides a relatively localized field of view. Future experiments could investigate higher magnifications, including 40×, to capture finer cellular and nuclear features, while simultaneously incorporating larger fields of view to preserve contextual and architectural information. Rather than simply increasing magnification, an effective approach would be to jointly model high-resolution local features and lower-resolution contextual information. This could be achieved through multi-scale patch extraction, hierarchical feature aggregation, or architectures capable of integrating representations from multiple spatial resolutions.<br>

With approximately an order of magnitude more computational resources, these approaches could be explored systematically, including domain-specific self-supervised pretraining, multi-magnification feature extraction, larger fields of view, and more computationally intensive slide-level aggregation strategies. Such experiments may provide a more comprehensive assessment of whether adapting the representation-learning process to lung adenocarcinoma morphology can further improve seven-class subtype classification.<br>