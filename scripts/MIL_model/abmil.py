from MIL_model.mil_template import MIL
import os, sys
import torch
import torch.nn as nn
import torch.nn.functional as F
from MIL_model.layers import GlobalAttention, GlobalGatedAttention, create_mlp
...
class ABMIL(MIL):
    ...
    def forward(self, h: torch.Tensor,
                ...
                return_slide_feats: bool = True) -> torch.Tensor:
        """
